...
return (function (p1__922_SHARP_){
return console.log(cljs.core.clj__GT_js.call(null,p1__922_SHARP_));
});})(state))
);
});
goog.exportSymbol('hello.core.eval_t', hello.core.eval_t);
hello.core.compile_simple = (function hello$core$compile_simple(src,name,cb){
var state = cljs.js.empty_state.call(null);
